        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center">
                <div class="flex items-center ms-3">
                    <div>
                        <button type="button" class="flex text-smrounded-full focus:ring-4 focus:ring-gray-300"
...
<aside id="logo-sidebar"
    ...
    <div class="h-full px-3 pb-4 overflow-y-auto bg-white ">
        ...
        <a class="flex items-center mb-5">
            {{-- <img src="{{ asset('img/logojm.jpg') }}" class="mx-auto sm:h-20" alt="logojm" /> --}}
        </a>
        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="{{ route('perusahaan') }}"
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Perusahaan</span>
                </a>
            </li>
            <li>
                <a href="{{ route('mobil') }}"
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Mobil</span>
                </a>
            </li>
            <li>
                <a href="{{ route('pembelian') }}"
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Form Pembelian</span>
                </a>
            </li>
        </ul>
    </div>
